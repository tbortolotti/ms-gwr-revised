...
#func is either SEC_only_calibration or ESC_only_calibration
bw_gcv = function(bw_min, bw_max, step, func, Xc, Xe, Xs, y,intercept, utm_1_sp, utm_2_sp){
  bandwidths = seq(bw_min, bw_max, step)
  if (bandwidths[end(bandwidths)[1]]<bw_max-0.0001){
    bandwidths = c(bandwidths, bw_max)
  }
  ...
  for (w in 1:length(bandwidths)){
    i = bandwidths[w]
    print(c("Bandwidth", i))
    temp = func(Xc, Xe, Xs, y, intercept, i, i, utm_1_sp, utm_2_sp)
    B = temp$B
    n = length(y)
    I = diag(1,n)
...
bw_gcv_mei = function(bw_min, bw_max, step, func, Xc, Xe, Xs, y,intercept, utm_1_sp, utm_2_sp){
  bandwidths = seq(bw_min, bw_max, step)
  if (bandwidths[end(bandwidths)[1]]<bw_max-0.0001){
    bandwidths = c(bandwidths, bw_max)
  }
...
#GCV for ESC and SEC in EMGWR with constant intercept
#func is either SEC_only_calibration or ESC_only_calibration
gcv_mei_only_one = function(bw1, bw2, func, Xc, Xe, Xs, y,intercept, utm_1_sp, utm_2_sp){
  temp = func(Xc, Xe, Xs, y, intercept, bw1, bw2, utm_1_sp, utm_2_sp)
  B = temp$B
  n = length(y)
  I = diag(1,n)
  Xcc = cbind(rep(1,n), Xc)
...
#SEC_general----
SEC_general = function(Xc, Xe, Xs, y,intercept, bw1, bw2, utm_1_sp, utm_2_sp, grid){
...
#SCE_general----
SCE_general = function(Xc, Xe, Xs, y,intercept, bw1, bw2, utm_1_sp, utm_2_sp, grid){
  dist_e_sim = gw.dist(utm_1_sp, grid, focus=0, p=2, theta=0, longlat=F)
  dist_s_sim = gw.dist(utm_2_sp, grid, focus=0, p=2, theta=0, longlat=F)
  dist_e_sim_cal = gw.dist(utm_1_sp, utm_1_sp, focus=0, p=2, theta=0, longlat=F)
  dist_s_sim_cal = gw.dist(utm_2_sp, utm_2_sp, focus=0, p=2, theta=0, longlat=F)
...
#ECS_general----
ECS_general = function(Xc, Xe, Xs, y,intercept, bw1, bw2, utm_1_sp, utm_2_sp, grid){
  dist_e_sim = gw.dist(utm_1_sp, grid, focus=0, p=2, theta=0, longlat=F)
  dist_s_sim = gw.dist(utm_2_sp, grid, focus=0, p=2, theta=0, longlat=F)
  dist_e_sim_cal = gw.dist(utm_1_sp, utm_1_sp, focus=0, p=2, theta=0, longlat=F)
  dist_s_sim_cal = gw.dist(utm_2_sp, utm_2_sp, focus=0, p=2, theta=0, longlat=F)
...
#CSE_general----
CSE_general = function(Xc, Xe, Xs, y,intercept, bw1, bw2, utm_1_sp, utm_2_sp, grid){
  dist_e_sim = gw.dist(utm_1_sp, grid, focus=0, p=2, theta=0, longlat=F)
  dist_s_sim = gw.dist(utm_2_sp, grid, focus=0, p=2, theta=0, longlat=F)
  dist_e_sim_cal = gw.dist(utm_1_sp, utm_1_sp, focus=0, p=2, theta=0, longlat=F)
  dist_s_sim_cal = gw.dist(utm_2_sp, utm_2_sp, focus=0, p=2, theta=0, longlat=F)
...
#CES_general----
CES_general = function(Xc, Xe, Xs, y,intercept, bw1, bw2, utm_1_sp, utm_2_sp, grid){
  dist_e_sim = gw.dist(utm_1_sp, grid, focus=0, p=2, theta=0, longlat=F)
  dist_s_sim = gw.dist(utm_2_sp, grid, focus=0, p=2, theta=0, longlat=F)
  dist_e_sim_cal = gw.dist(utm_1_sp, utm_1_sp, focus=0, p=2, theta=0, longlat=F)
  dist_s_sim_cal = gw.dist(utm_2_sp, utm_2_sp, focus=0, p=2, theta=0, longlat=F)
...
#bw1, bw2, utm_1_sp, utm_2_sp are calibration coordinates
...
emgwr_prediction_points = function(Xc, Xe, Xs, y, emgwr, H_hat, delta1, delta2, method, bw1, bw2, utm_1_sp, utm_2_sp, pc, pe, ps, pcoords, alfa){
...
emgwr_prediction_points_no_param = function(Xc, Xe, Xs, y, emgwr, method, bw1, bw2, utm_1_sp, utm_2_sp, pc, pe, ps, pcoords, alfa){
...
ESC_only_calibration = function(Xc, Xe, Xs, y,intercept, bw1, bw2, utm_1_sp, utm_2_sp){
  dist_e_sim_cal = gw.dist(utm_1_sp, utm_1_sp, focus=0, p=2, theta=0, longlat=F)
  dist_s_sim_cal = gw.dist(utm_2_sp, utm_2_sp, focus=0, p=2, theta=0, longlat=F)
...
ESC_only_constant_intercept_calibration = function(Xe, Xs, y, bw1, bw2, utm_1_sp, utm_2_sp){
  dist_e_sim_cal = gw.dist(utm_1_sp, utm_1_sp, focus=0, p=2, theta=0, longlat=F)
  dist_s_sim_cal = gw.dist(utm_2_sp, utm_2_sp, focus=0, p=2, theta=0, longlat=F)
...
ESC_no_intercept_calibration = function(Xc, Xe, Xs, y, bw1, bw2, utm_1_sp, utm_2_sp){
  dist_e_sim_cal = gw.dist(utm_1_sp, utm_1_sp, focus=0, p=2, theta=0, longlat=F)
  dist_s_sim_cal = gw.dist(utm_2_sp, utm_2_sp, focus=0, p=2, theta=0, longlat=F)
...
#ESC_grid_creation----
ESC_grid_creation = function(Xc, Xe, Xs, y,intercept, bw1, bw2, utm_1_sp, utm_2_sp, grid, emgwr){
  dist_e_sim = gw.dist(utm_1_sp, grid, focus=0, p=2, theta=0, longlat=F)
  dist_s_sim = gw.dist(utm_2_sp, grid, focus=0, p=2, theta=0, longlat=F)
...
SEC_only_calibration = function(Xc, Xe, Xs, y,intercept, bw1, bw2, utm_1_sp, utm_2_sp){
  dist_e_sim_cal = gw.dist(utm_1_sp, utm_1_sp, focus=0, p=2, theta=0, longlat=F)
  dist_s_sim_cal = gw.dist(utm_2_sp, utm_2_sp, focus=0, p=2, theta=0, longlat=F)
...
SEC_only_constant_intercept_calibration = function(Xe, Xs, y, bw1, bw2, utm_1_sp, utm_2_sp){
  dist_e_sim_cal = gw.dist(utm_1_sp, utm_1_sp, focus=0, p=2, theta=0, longlat=F)
  dist_s_sim_cal = gw.dist(utm_2_sp, utm_2_sp, focus=0, p=2, theta=0, longlat=F)
...
SEC_no_intercept_calibration = function(Xc, Xe, Xs, y, bw1, bw2, utm_1_sp, utm_2_sp){
  dist_e_sim_cal = gw.dist(utm_1_sp, utm_1_sp, focus=0, p=2, theta=0, longlat=F)
  dist_s_sim_cal = gw.dist(utm_2_sp, utm_2_sp, focus=0, p=2, theta=0, longlat=F)
...
#SEC_grid_creation----
SEC_grid_creation = function(Xc, Xe, Xs, y,intercept, bw1, bw2, utm_1_sp, utm_2_sp, grid, emgwr){
  dist_e_sim = gw.dist(utm_1_sp, grid, focus=0, p=2, theta=0, longlat=F)
  dist_s_sim = gw.dist(utm_2_sp, grid, focus=0, p=2, theta=0, longlat=F)
...
mixed_SC_no_intercept_calibration = function(Xc, Xs, y, bw, utm_sp){
