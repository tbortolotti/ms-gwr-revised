#'
#' SEC algorithm for full calibration and computation of the regression coefficients
#'
#' This function builds matrices He, Hs and B that are used for the MS-GWR
#' via SEC algorithm and estimates the regression coefficients over a grid of coordinates given as input
#'
